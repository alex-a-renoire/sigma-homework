...
func (c *storageServiceClient) GetAllPersons(ctx context.Context, in *empty.Empty, opts ...grpc.CallOption) (*AllPersonsResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/grpcserver.StorageService/GetAllPersons", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *storageServiceClient) DeletePerson(ctx context.Context, in *DeletePersonRequest, opts ...grpc.CallOption) (*empty.Empty, error) {
	out := new(empty.Empty)
	err := c.cc.Invoke(ctx, "/grpcserver.StorageService/DeletePerson", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _StorageService_AddPerson_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/grpcserver.StorageService/AddPerson",
	}
...
func _StorageService_GetAllPersons_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/grpcserver.StorageService/GetAllPersons",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _StorageService_DeletePerson_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/grpcserver.StorageService/DeletePerson",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
var StorageService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "grpcserver.StorageService",
